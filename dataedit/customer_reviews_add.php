...
$customer_photo=$next_increment. ".".$imageFileType;
$customer_phone=mysqli_real_escape_string($con,$_POST['customer_phone']);
$customer_place=mysqli_real_escape_string($con,$_POST['customer_place']);
$customer_review=mysqli_real_escape_string($con,$_POST['customer_review']);
$sql = "INSERT INTO customer_reviews (customer_name, customer_photo, customer_phone, customer_place, customer_review)
VALUES ('$customer_name', '$customer_photo', '$customer_phone','$customer_place','$customer_review')";
if ($uploadOk == 1) {
...
Place: <input type="text" name="customer_place"><br>
Review: <textarea rows="10" cols="60"  name="customer_review"></textarea><br>
